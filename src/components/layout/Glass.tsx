...
export default function Glass() {
  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-40">
      {/* глубина стекла */}
      <div className="absolute inset-0 bg-[radial-gradient(130%_85%_at_50%_45%,transparent_50%,rgba(3,5,10,0.78)_100%)]" />
      ...
      {/* полоса сканирования */}
      <div className="hud-sweep absolute inset-x-0 h-28 bg-[linear-gradient(to_bottom,transparent,rgba(55,212,200,0.055),transparent)]" />
